...
<body class="w-full flex bg-[#fffeff]">
    ...
    <div class="w-full flex flex-col justify-start">
        ...
        <button onclick="window.location.href='history.php'" class="py-3 flex gap-4 items-center text-left hover:bg-[#dddfdd] px-8 rounded-tr-full rounded-br-full text-sm">
    ...
    <div class="w-full p-4">
        <div class="w-full mb-10">
            <iframe class="block mx-auto" src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d15468.64246827663!2d121.15957300000001!3d14.24385105!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sen!2sph!4v1713404611663!5m2!1sen!2sph" width="1200" height="300" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        </div>
        <p class="text-center mb-5">As of <?php echo $current_date; ?> <span id="clock"></span></p>
        <div id="table" class="w-11/12 block mx-auto">
    ...
    <script>
        ...
        // Function to toggle blur class on the body element
        function toggleBlur(hasContent) {
            document.body.classList.toggle('modal-blur', hasContent);
        }

        // Function to check if result div has contents
        function checkResultContent() {
            const result = document.getElementById('result');
            const hasContent = result.innerHTML.trim().length > 0;
            toggleBlur(hasContent);
        }
