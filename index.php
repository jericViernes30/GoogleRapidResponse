...
<body class="w-full overflow-hidden bg-[#f0f0f0]">
    ...
    <div class="w-3/4 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 p-10 rounded-3xl bg-white">
        <div class="w-full flex flex-col">
            <img src="src/public/images/logo.png" alt="" class="w-1/12 mb-4">
            <div class="w-full flex">
                <div class="w-1/2 flex flex-col gap-3">
                    <p class="text-3xl text-gray-800 mb-2 font-medium">Log in</p>
